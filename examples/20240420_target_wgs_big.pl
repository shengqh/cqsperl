...
my $def = merge_hash_right_precedent(gatk_hg38_genome(), {
  task_name => "target_wgs",
  email => "quanhu.sheng.1\@vumc.org",
  target_dir => create_directory_or_die("/nobackup/h_cqs/shengq2/temp/20240421_target_wgs_big_files_v2"),
...
#performTaskByPattern($config, "bwa_02_markduplicates");
#performTaskByPattern($config, "gatk4_");
