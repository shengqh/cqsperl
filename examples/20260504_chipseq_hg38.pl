...
my $def = {
  ...
  target_dir       => create_directory_or_die("/nobackup/h_cqs/shengq2/test/20260504_chipseq_hg38"),
  add_folder_index => 0,
  ...
  design_table => {
    "Pol2" => {
      ...
      "Comparison" => [ [ "TNF_Veh_vs_NoTreatment", "No_Treatment", "TNF_Veh" ], [ "THZ_TNF_vs_NoTreatment", "No_Treatment", "THZ_TNF" ], ],
      "MinOverlap" => {
        "No_Treatment" => 2,
        "TNF_Veh"      => 2,
        "THZ_TNF"      => 2,
