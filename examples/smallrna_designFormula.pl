...
my $def = {
    ...
    target_dir =>"/nobackup/h_cqs/shengq2/temp",
  ...
  pairs => {
    'PA_cell_vs_VC_cell' => {
      groups => ['Veh', 'PA'],
      covariances => ['case', 'cell'],
      designFormula => "~ case + cell + case*cell",
    },
  }
};
...
$config->{"deseq2_miRNA_TotalReads"}{target_dir} = "/nobackup/h_cqs/shengq2/temp/deseq2_miRNA_TotalReads_formula";
