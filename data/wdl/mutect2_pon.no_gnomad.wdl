...
#Changes: 1. /root/gatk.jar to /gatk/gatk.jar; 2. remove all --germline-resource ~{gnomad} as no such information for mm10; 
# 3. mutect2.wdl was changed to add bcftools norm to mutect2 vcf before making PON
#  
...
#        }
    ...
    command {
        ...
        gatk --java-options "-Xmx~{command_mem}g"  CreateSomaticPanelOfNormals -R ~{ref_fasta} \
