...
sub global_definition {
  return merge_hash_right_precedent(global_options(), {
    ...
    gatk4_docker_command => singularity_prefix() . " /data/cqs/softwares/singularity/cqs-gatk-4.6.2.0.20251008.sif ",
    gatk4140_docker_command => singularity_prefix() . " /data/cqs/softwares/singularity/gatk.4.1.4.0.sif ",
    ...
    wdl => {
      "local" => {
        ...
        "somaticCNV_pon" => {
          "wdl_file" => "/data/cqs/softwares/gatk-4.6.2.0/scripts/cnv_wdl/somatic/cnv_somatic_panel_workflow.wdl"
        },
        "somaticCNV" => {
          "wdl_file" => "/data/cqs/softwares/gatk-4.6.2.0/scripts/cnv_wdl/somatic/cnv_somatic_pair_workflow.wdl"
        },
...
sub gatk_hg38_genome {
  ...
  my $result = merge_hash_right_precedent(
    $global_hg38,
    {
      ...
      #somhow the original 50 intervals might cause the disorder of the sorted reads. Use the one generated by WDL pipeline.
      ...
      annovar_param => "-protocol refGene,cytoBand,dbsnp157,cosmic70,exac03,1000g2015aug_all,1000g2015aug_afr,1000g2015aug_amr,1000g2015aug_eas,1000g2015aug_eur,1000g2015aug_sas,gnomad41_genome,clinvar_20260816 -operation g,r,f,f,f,f,f,f,f,f,f,f,f --remove",
