...
sub add_human_gsea {
  ...
  return merge_hash_left_precedent(
    $def,
    { perform_gsea     => 1,
...
} ## end sub get_gencode_hg38_genome
...
sub add_mouse_gsea {
  ...
  return merge_hash_right_precedent(
    ...
    { perform_gsea     => 1,
      ...
      software_version => { "GSEA_DB" => ["${mouse_gsea_db_ver}"], }
    }
  );
} ## end sub add_mouse_gsea
...
} ## end sub get_gencode_mm10_genome
...
sub performRNASeq_gencode_hg19 {
  ...
  return $config;
} ## end sub performRNASeq_gencode_hg19
...
sub performRNASeq_gencode_hg38 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_gencode_hg38
...
sub performRNASeq_gencode_hg38_v47 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_gencode_hg38_v47
...
sub performRNASeq_gencode_hg38_v37 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_gencode_hg38_v37
...
sub performRNASeq_gencode_hg38_v33 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_gencode_hg38_v33
...
sub performRNASeq_gencode_mm10 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_gencode_mm10
...
sub performRNASeq_ensembl_Rnor_6 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_ensembl_Rnor_6
...
sub performRNASeq_ensembl_Mmul10 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_ensembl_Mmul10
...
sub performRNASeq_ensembl_GRCz11 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_ensembl_GRCz11
...
sub performRNASeq_ncbi_Sscrofa11 {
  ...
  my $config = performRNASeq( $def, $perform );
  return $config;
} ## end sub performRNASeq_ncbi_Sscrofa11
