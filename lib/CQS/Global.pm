...
sub gencode_hg19_databases {
  return {
    #aligner database
    bowtie2_index => "/data/cqs/references/gencode/GRCh37.p13/bowtie2_index_2.4.3/Homo_sapiens_assembly19",
    bowtie1_fasta => "/data/cqs/references/gencode/GRCh37.p13/bowtie_index_1.3.0/Homo_sapiens_assembly19.fa",
    bowtie1_index => "/data/cqs/references/gencode/GRCh37.p13/bowtie_index_1.3.0/Homo_sapiens_assembly19",
    bwa_fasta     => "/data/cqs/references/gencode/GRCh37.p13/bwa_index_0.7.17/Homo_sapiens_assembly19.fa",
