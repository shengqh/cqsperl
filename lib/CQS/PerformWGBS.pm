...
sub global_definition {
  my $result = merge_hash_right_precedent(global_options(), {
    ...
    wgbs_r_docker_command => singularity_prefix() . " /data/cqs/softwares/singularity/cqs_wgbs.20260925.sif ",
...
sub gencode_hg38_genome {
  return merge_hash_right_precedent(global_definition(), {
    ...
    annovar_param       => "--otherinfo -protocol refGene,dbsnp157,clinvar_20260905 -operation g,f,f --remove",
