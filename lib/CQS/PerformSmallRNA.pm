...
our %EXPORT_TAGS = (
  'all' => [
    qw(hg19_genome hg19_3utr hg38_genome mm10_genome mm10_3utr rn5_genome cel235_genome cfa3_genome performSmallRNA_hg19 performSmallRNATask_hg19 performSmallRNA_hg38 performSmallRNATask_hg38 performSmallRNA_mm10 performSmallRNATask_mm10 performSmallRNA_rn5 performSmallRNATask_rn5
      ...
      performSmallRNA_oar3 performSmallRNATask_oar3 performSmallRNA_gga4 performSmallRNATask_gga4 performSmallRNA_fca6 performSmallRNATask_fca6 supplement_genome)
  ]
);
...
sub hg38_genome {
  return merge(
    supplement_genome(),
    {
      ...
      #genome database
      mirbase_count_option  => "-p hsa",
      coordinate            => "/scratch/cqs/shengq1/references/smallrna/hg38_miRBase21_GtRNAdb2_gencodeV24.bed",
      coordinate_fasta      => "/scratch/cqs/shengq1/references/smallrna/hg38_miRBase21_GtRNAdb2_gencodeV24.bed.fa",
      bowtie1_index         => "/scratch/cqs/shengq1/references/gencode/hg38/bowtie_index_1.1.2/GRCh38.p5.genome",
...
sub hg38_3utr {
  return {
    ...
    fasta_file    => "/scratch/cqs/shengq1/references/gencode/hg38/bowtie_index_1.1.2/GRCh38.p5.genome.fa",
